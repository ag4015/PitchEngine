...
void ParameterManager::CartesianRecurse(std::vector<std::vector<int64_t>> &accum, std::vector<int64_t> stack,
...
std::vector<std::vector<int64_t>> ParameterManager::CartesianProduct(std::vector<std::vector<int64_t>>& sequences)
{
...
ParameterManager::ParameterManager(parameterCombinations_t& paramCombs, dontCares_t& dontCares, std::string& dontCareKey,
...
ParameterManager::ParameterManager(const ParameterManager& other)
...
std::string ParameterManager::constructVariationName(const parameterInstanceMap_t& paramInstance)
{
...
const parameterInstanceSet_t* ParameterManager::getParameterInstanceSet()
{
	return parameterInstanceSet_.get();
}

const parameterCombinations_t* ParameterManager::getParameterCombinations()
{
	return &paramCombs_;
}

void ParameterManager::addParametersWithoutRegeneratingCombinations(parameterCombinations_t& paramCombs, dontCares_t& dontCares,

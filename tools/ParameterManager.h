...
public:
	...
	ParameterManager(parameterCombinations_t& paramCombs, dontCares_t& dontCares, std::string& dontCareKey,
		parameterTypeMap_t& parameterTypeMap, printableParams_t& printableParameters);
	ParameterManager(const ParameterManager& other);
	...
	void addParametersWithoutRegeneratingCombinations(parameterCombinations_t& paramCombs, dontCares_t& dontCares,
